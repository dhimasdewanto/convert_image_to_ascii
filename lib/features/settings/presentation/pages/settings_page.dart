                  ...
                  return ListView(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle:
                            Text("${settingsModel.listCharacters.length}"),
                        onTap: () {
                          showDialog(
                            context: context,
                        ...
                        leading: status == HelperStatus.totalCharacters
                            ? const AnimatedArrow()
                            : null,
                        trailing: IconButton(
                      ...
                      ListTile(
                        ...
                        leading: status == HelperStatus.characters
                            ? const AnimatedArrow()
                            : null,
                        trailing: IconButton(
                          icon: const Icon(Icons.info_outline),
                      ...
                      ListTile(
                        ...
                        leading: status == HelperStatus.colors
                            ? const AnimatedArrow()
                            : null,
                        onTap: () {
                          push(
